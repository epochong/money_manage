<%@ page import="com.imooc.mm.entity.Employee" %>
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown menu-merge">
                <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
                    ...
                    <span class="hidden-xs pl15"> <%=((Employee)session.getAttribute("employee")).getName()%></span>
                ...
                <div class="sidebar-widget author-widget">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div class="media-author"><%=((Employee)session.getAttribute("employee")).getName()%>--<%=((Employee)session.getAttribute("employee")).getPost()%></div>
